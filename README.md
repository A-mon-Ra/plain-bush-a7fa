...
```
npm create cloudflare@latest -- --template=cloudflare/templates/plain-bush-a7fa
```

A live public deployment of this template is available at [https://plain-bush-a7fa.templates.workers.dev](https://plain-bush-a7fa.templates.workers.dev)
